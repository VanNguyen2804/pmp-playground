-- PostgreSQL/Neon migration for existing PMP Playground databases.
-- Hibernate ddl-auto=update can add these columns automatically, but this script is safer for production.
